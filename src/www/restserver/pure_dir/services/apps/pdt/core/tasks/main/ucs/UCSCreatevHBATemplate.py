...
class UCSCreatevHBATemplateInputs:
    fabric_id = Dropdown(hidden='True', isbasic='True', helptext='', api="getfilist()", dt_type="string", label="UC Fabric Name", mandatory="1",
                         mapval="0", name="fabric_id", static="False", svalue="", static_values="None", order=1)
    vhba_name = Textbox(validation_criteria='str|min:1|max:128',  hidden='False', isbasic='True', helptext='vHBA Name', dt_type="string", static="False", static_values="None", api="",
                        name="vhba_name", label="Name", svalue="", mandatory='1', mapval="0", order=2)
    vhba_description = Textbox(validation_criteria='str|min:1|max:128',  hidden='False', isbasic='True', helptext='', dt_type="string", static="False",  static_values="None", api="",
                               name="vhba_description", label="Description", svalue="", mandatory='1', mapval="0", order=3)
    ...
    max_data_field_size = Textbox(validation_criteria='int|min:256|max:2048',  hidden='False', isbasic='True', helptext='', dt_type="integer", api="", static="False", static_values="None",
                                  name="max_data_field_size", label="Max Data Field Size", svalue="", mandatory='1', mapval="0", order=7)
    template_type = Radiobutton(hidden='False', isbasic='True', helptext='', dt_type="string", api="", static="True", static_values="initial-template:1:Initial Template|updating-template:0:Updating Template",
                                label="Template Type",  name="template_type", svalue="", mandatory='1', mapval="0", order=8)
    vsan_name = Dropdown(hidden='False', isbasic='True', helptext='', dt_type="string", static="False", api="getvsan()|[fabric_id:1:fabric_id.value|ucs_fabric_id:1:ucs_fabric_id.value]",
                         mapval="1", name="vsan_name", static_values="None", label="Select VSAN", svalue="", mandatory='1', order=9)
