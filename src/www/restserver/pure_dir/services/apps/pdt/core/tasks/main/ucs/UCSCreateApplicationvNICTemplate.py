...
class UCSCreateApplicationvNICTemplateInputs:
    fabric_id = Dropdown(
        ...
        mandatory="1",
        order=1)
    application_vnic_templ_name = Textbox(
        validation_criteria='str|min:1|max:128',
        hidden='False',
        isbasic='True',
        helptext='Application vNIC Template',
        api="",
        dt_type="string",
        label="Name",
        mapval="0",
        name="application_vnic_templ_name",
        static="False",
        svalue="vNIC_App_A",
        mandatory='1',
        static_values="",
        order=2)
    application_vnic_templ_desc = Textbox(
        validation_criteria='str|min:1|max:128',
        hidden='False',
        isbasic='True',
        ...
        label="Description",
        mapval="0",
        name="application_vnic_templ_desc",
        static="False",
        svalue="",
        mandatory='1',
        static_values="",
    ...
    vlans = Checkbox(
        ...
        name="vlans",
        static="False",
        svalue="__t212.UCSCreateTrafficVLAN.vlan_name|__t213.UCSCreateTrafficVLAN.vlan_name|__t214.UCSCreateTrafficVLAN.vlan_name",
        mandatory='1',
        static_values="",
        allow_multiple_values="1",
        order=8)
    native_vlan = Checkbox(
        hidden='False',
        isbasic='True',
        ...
        svalue="default",
        mandatory='1',
        static_values="default:1:default",
