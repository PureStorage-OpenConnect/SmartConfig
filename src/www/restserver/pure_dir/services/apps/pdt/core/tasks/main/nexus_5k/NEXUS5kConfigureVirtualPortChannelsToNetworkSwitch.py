...
metadata = dict(
        task_id="NEXUS5kConfigureVirtualPortChannelsToNetworkSwitch",
...
class NEXUS5kConfigureVirtualPortChannelsToNetworkSwitch:
    def __init__(self):
        pass
...
class NEXUS5kConfigureVirtualPortChannelsToNetworkSwitchInputs:
...
class NEXUS5kConfigureVirtualPortChannelsToNetworkSwitchOutputs:
