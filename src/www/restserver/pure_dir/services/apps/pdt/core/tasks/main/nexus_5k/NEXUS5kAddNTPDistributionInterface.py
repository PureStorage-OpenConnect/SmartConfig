...
class NEXUS5kAddNTPDistributionInterface:
    def __init__(self):
        pass
...
class NEXUS5kAddNTPDistributionInterfaceInputs:
    ...
    gateway = Textbox(validation_criteria='ip', hidden='', isbasic='True', helptext='Gateway address', dt_type="string",
                      static="False", api="", name="gateway",
                      static_values="", label="Gateway", svalue="", mapval="", mandatory="1", order=2)
    route = Textbox(validation_criteria='ip', hidden='', isbasic='True', helptext='Route address', dt_type="string",
                    static="False", api="", name="route", label="Route",
                    static_values="", svalue="0.0.0.0/0", mapval="", mandatory="1", order=3)
    mask_length = Textbox(validation_criteria='int|min:1|max:31', hidden='', isbasic='True', helptext='Netmask length',
                          dt_type="string", static="False", api="", name="mask_length",
                          static_values="", label="Mask length", svalue="24", mapval="", mandatory="1", order=4)
    stratum_no = Textbox(validation_criteria='int|min:1|max:15', hidden='', isbasic='True',
                         helptext='Stratum number for NTP', dt_type="string", static="False", api="", name="stratum_no",
                         static_values="", label="Stratum number", svalue="3", mapval="", mandatory="1", order=5)
    vlan_id = Textbox(validation_criteria='int|min:1|max:3967', hidden='', isbasic='True', helptext='Virtual LAN id',
                      dt_type="string", static="False", api="", name="vlan_id",
                      static_values="", label="VLAN id", svalue="115", mapval="", mandatory="1", order=6,
                      recommended="1")


class NEXUS5kAddNTPDistributionInterfaceOutputs:
