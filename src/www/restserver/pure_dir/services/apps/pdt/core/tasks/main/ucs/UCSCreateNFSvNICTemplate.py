...
metadata = dict(
    task_id="UCSCreateNFSvNICTemplate",
    task_name="Create NFS vNIC Template for FlashBlade",
    task_desc="Create NFS vNIC template for FlashBlade in UCS",
    task_type="UCSM"
)


class UCSCreateNFSvNICTemplate:
    def __init__(self):
        pass

    def execute(self, taskinfo, fp):
        loginfo("create_NFS_vNIC_Template_FB")
    ...
    def rollback(self, inputs, outputs, logfile):
        loginfo("create NFS vNIC Template rollback")
...
class UCSCreateNFSvNICTemplateInputs:
    fabric_id = Dropdown(
        hidden='True',
        isbasic='True',
        helptext='',
    ...
    vnic_templ_desc = Textbox(
        ...
        static="False",
        svalue="NFS vNIC Template for Fabric A",
        mandatory='1',
        static_values="",
        order=3)
    ...
    vlans = Checkbox(
        ...
        name="vlans",
        static="False",
        svalue="__t209.UCSCreateAIMLNFSVLAN.vlan_name",
        allow_multiple_values="1",
        mandatory='1',
        static_values="",
        order=9)
...
class UCSCreateNFSvNICTemplateOutputs:
    ...
    vnic_templ_name = Output(
        dt_type="string", name="vnic_templ_name", tvalue="BM-NFS-A")
