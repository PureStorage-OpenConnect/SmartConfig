...
class UCSCreatevHBAInputs:
    ...
    ucs_fabric_id = Radiobutton(
        ...
        mapval="0",
        order=3)
    vhba_template = Dropdown(
        hidden='False',
        isbasic='True',
        helptext='vHBA template name',
        dt_type="string",
        api="getvhbatemplate()|[fabric_id:1:fabric_id.value|ucs_fabric_id:1:ucs_fabric_id.value]",
        static="False",
        static_values="None",
        mapval="1",
        name="vhba_template",
        ...
        mandatory='1',
        order=4)
    vsan_con_policy = Dropdown(
        hidden='False',
        isbasic='True',
        helptext='VSAN Connectivity Policy',
        dt_type="string",
        name="vsan_con_policy",
        static="False",
        api="getsanconnectivity()|[fabric_id:1:fabric_id.value]",
        static_values="None",
        mapval="1",
        label="vSAN Connectivity Policy Name",
        svalue="",
        mandatory='1',
        order=5)
