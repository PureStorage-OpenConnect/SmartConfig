...
metadata = dict(
    task_id="UCSCreateTrafficvNICTemplate",
    task_name="Create Traffic vNIC Template for FlashBlade",
    task_desc="Create Traffic vNIC template for FlashBlade in UCS",
    task_type="UCSM"
)


class UCSCreateTrafficvNICTemplate:
    def __init__(self):
        pass

    def execute(self, taskinfo, fp):
        loginfo("create_Traffic_vNIC_Template_FB")
    ...
    def rollback(self, inputs, outputs, logfile):
        loginfo("create Traffic vNIC Template rollback")
...
class UCSCreateTrafficvNICTemplateInputs:
    fabric_id = Dropdown(
        hidden='True',
        isbasic='True',
        helptext='',
    ...
    vnic_templ_name = Textbox(
        ...
        hidden='False',
        isbasic='True',
        helptext='Traffic vnic template',
        api="",
        dt_type="string",
        label="Name",
        mapval="0",
    ...
    vnic_templ_desc = Textbox(
        ...
        static="False",
        svalue="Traffic vNIC Template for Fabric A",
        mandatory='1',
        static_values="",
        order=3)
    ...
    vlans = Checkbox(
        ...
        name="vlans",
        static="False",
        svalue="__t210.UCSCreateDataTrafficVLAN.vlan_name",
        allow_multiple_values="1",
        mandatory='1',
        static_values="",
        order=9)
    ...
    ident_pool_name = Dropdown(
        ...
        static="False",
        svalue="__t198.CreateMACAddressPoolsForFabricB.mac_name",
        mandatory='1',
        static_values="",
        order=13)
...
class UCSCreateTrafficvNICTemplateOutputs:
    ...
    vnic_templ_name = Output(
        dt_type="string", name="vnic_templ_name", tvalue="BM-Traffic-B")
