    ...
    def get_iscsi_interfaces(self, pureid):
        ...
        for interface in result_data.getResult():
            interface_list.append(
                {"id": str(interface['name']), "selected": "0", "label": str(interface['name'])})
        obj.release_pure_handle()
...
class FlashArrayConfigureNIInputs:
    ...
    address = Textbox(validation_criteria='ip',  hidden='False', isbasic='True', helptext='IP Address', dt_type="string", static="False", api="", name="address", label="Address",
                      svalue="", static_values="", mandatory="0", mapval="", order=4)
    netmask = Textbox(validation_criteria='ip',  hidden='False', isbasic='True', helptext='Netmask', dt_type="string", static="False", api="", name="netmask", label="Netmask",
                      svalue="", static_values="", mandatory="0", mapval="", order=5)
    mtu = Textbox(validation_criteria='int|min:1|max:9000',  hidden='False', isbasic='True', helptext='MTU', dt_type="integer", static="False", api="", name="mtu", label="MTU",
                  svalue="9000", static_values="", mandatory="0", mapval="", order=8, recommended="1")
