                ...
                if res.getStatus() == PTK_OKAY:
                    ...
                    if res.getStatus() == PTK_OKAY:
                        ...
                        if res.getStatus() != PTK_OKAY:
                            ...
                            customlogs(
                                "MDS Zoning executed successfully", logfile)
                ...
                if res.getStatus() == PTK_OKAY:
                    ...
                    if res.getStatus() == PTK_OKAY:
                        ...
                        if res.getStatus() != PTK_OKAY:
                            ...
                            customlogs(
                                "MDS Zoning rollback executed successfully", logfile)
                            res.setResult(
                                parseResult(res)['data'],
                                PTK_OKAY,
                                _("PDT_SUCCESS_MSG"))
...
class MDSZoningInputs:
    ...
    flogi_list = Group(
        ...
        dt_type="string",
        static="False",
        api="get_flogi_sessions()|[mds_id:1:mds_id.value]",
        name="flogi_list",
        label="FLOGI List",
        static_values="",
    ...
    vsan_id = Dropdown(
        ...
        dt_type="string",
        static="False",
        api="get_vsan_list()|[mds_id:1:mds_id.value]",
        name="vsan_id",
        static_values="",
        label="VSAN",
        svalue="101",
