...
class UCSSynchronizeUCStoNTPInputs:
    ...
    zone = Dropdown(hidden='False', isbasic='True', helptext='Time Zone', api="gettimezones()", dt_type="string", label="Time Zone", mandatory="1",
                    mapval="0", name="zone", static="False", static_values="", svalue="Asia/Kolkata", order=2)
    ntp = Textbox(validation_criteria='ip',  hidden='False', isbasic='True', helptext='NTP Server', api="", dt_type="string", label="NTP Server", mandatory="1", mapval="0",
                  name="ntp", static="False", svalue="192.168.10.29", static_values="", order=3)
