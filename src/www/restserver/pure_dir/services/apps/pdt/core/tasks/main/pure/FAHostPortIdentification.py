...
class FAHostPortIdentificationInputs:
    ...
    iqn_pool_name = Dropdown(hidden='False', isbasic='True', helptext='', dt_type="string", static="False", api="", name="iqn_pool_name",
                             label="IQN Pool Name", svalue="IQN-Pool", mandatory="0", static_values="", mapval="", order=2, recommended="1")

    ports = Dropdown(hidden='False', isbasic='True', helptext='', dt_type="string", static="False", api="",
                     name="ports", label="Initiator Name", svalue="", static_values="", mapval="", mandatory="0", order=3)
