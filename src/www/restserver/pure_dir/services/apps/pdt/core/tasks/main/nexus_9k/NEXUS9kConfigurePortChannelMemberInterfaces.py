...
metadata = dict(
    task_id="NEXUS9kConfigurePortChannelMemberInterfaces",
...
class NEXUS9kConfigurePortChannelMemberInterfaces:
    def __init__(self):
        pass
...
class NEXUS9kConfigurePortChannelMemberInterfacesInputs:
    nexus_id = Dropdown(
        hidden='True',
        isbasic='',
        helptext='',
...
class NEXUS9kConfigurePortChannelMemberInterfacesOutputs:
