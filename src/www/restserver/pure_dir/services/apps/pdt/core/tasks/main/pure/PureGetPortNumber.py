...
class PureGetPortNumber:
    ...
    def get_controller_list(self, keys):
        """
        ...
        result_data = obj.get_controller_list()
...
class PureGetPortNumberInputs:
    ...
    name = Dropdown(hidden='False', isbasic='True', helptext='Controller Name', dt_type="list", api="get_controller_list()|[pure_id:1:pure_id.value]", static="False",
                    name="name", label="Controller name", svalue="", mandatory="0", static_values="", mapval="0", order=2, recommended="1")


class PureGetPortNumberOutputs:
