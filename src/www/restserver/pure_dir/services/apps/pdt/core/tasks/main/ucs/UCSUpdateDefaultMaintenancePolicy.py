...
class UCSUpdateDefaultMaintenancePolicyInputs:
    ...
    descr = Textbox(
        ...
        name="descr",
        static="False",
        svalue="Default maintenance policy",
        mandatory='1',
        static_values="",
        order=2)
    timer = Dropdown(
        ...
        api="",
        dt_type="string",
        label="Soft Shutdown Timer",
        mapval="0",
        name="timer",
        static="True",
        static_values="150-Secs:1:150 Secs|never:0:never|300-Secs:0:300 Secs|600-Secs:0:600 Secs",
        svalue="150-Secs",
        mandatory='1',
        order=3)
    uptime = Radiobutton(
        ...
        name="uptime",
        static="True",
        static_values="user-ack:1:User Ack|immediate:0:Immediate|timer-automatic:0:Timer Automatic",
        svalue="user-ack",
        mandatory='1',
        order=4)
    trigger = Checkbox(
        ...
        name="trigger",
        static="True",
        static_values="on-next-boot:1:On Next Boot",
        svalue="on-next-boot",
        mandatory='1',
