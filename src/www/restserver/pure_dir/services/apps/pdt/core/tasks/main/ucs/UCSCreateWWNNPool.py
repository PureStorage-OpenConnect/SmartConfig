...
class UCSCreateWWNNPoolInputs:
    ...
    name = Textbox(validation_criteria='str|min:1|max:128',  hidden='False', isbasic='True', helptext='WWNN Pool Name', dt_type="string", static="False", api="", name="name",
    ...
    from_ip = Textbox(validation_criteria='function',  hidden='False', isbasic='True', helptext='WWNN Pool From', dt_type="string", static="False", api="", name="from_ip",
                      label="From", static_values="", svalue="", mapval="", mandatory='1', order=5)
    size = Textbox(validation_criteria='int|min:1|max:1000',  hidden='False', isbasic='True', helptext='Size of WWNN Pool Block', dt_type="string", static="False", api="", name="size",
