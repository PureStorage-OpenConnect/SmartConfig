...
class Test_NEXUS9kAddIndividualPortDescription:
    def __init__(self):
        pass

    def execute(self, taskinfo, logfile):
        loginfo("Test NEXUS Add Individual Port Description")

        res = getMappedOutputs(taskinfo['jid'], taskinfo['texecid'])
        return res.getResult()

    def rollback(self, inputs, outputs, logfile):
        print "Test NEXUS Add Individual Port Description rollback"
        res = result()
