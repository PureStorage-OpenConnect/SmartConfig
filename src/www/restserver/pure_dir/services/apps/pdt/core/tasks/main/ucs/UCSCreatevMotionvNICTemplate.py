...
class UCSCreatevMotionvNICTemplateInputs:
    fabric_id = Dropdown(
        ...
        mandatory="1",
        order=1)
    vmotion_vnic_templ_name = Textbox(
        validation_criteria='str|min:1|max:128',
        hidden='False',
        isbasic='True',
        helptext='vMotion vNIC template',
        api="",
        dt_type="string",
        label="Name",
        mapval="0",
        name="vmotion_vnic_templ_name",
        static="False",
        svalue="vNIC_vMotion_A",
        mandatory='1',
        static_values="",
        order=2)
    vmotion_vnic_templ_desc = Textbox(
        validation_criteria='str|min:1|max:128',
        hidden='False',
        isbasic='True',
        ...
        label="Description",
        mapval="0",
        name="vmotion_vnic_templ_desc",
        static="False",
        svalue="vMotion vNIC template for fabric A",
        static_values="",
        mandatory='1',
        order=3)
    ...
    vlans = Checkbox(
        ...
        name="vlans",
        static="False",
        svalue="__t205.UCSCreatevMotionVLAN.vlan_name",
        mandatory='1',
        static_values="",
