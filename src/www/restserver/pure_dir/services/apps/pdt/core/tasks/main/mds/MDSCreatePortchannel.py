...
class MDSCreatePortchannelInputs:
    ...
    portchannel_id = Textbox(validation_criteria='int|min:1|max:256',  hidden='False', isbasic='True', helptext='Port channel ID', dt_type="string", static="False", api="", name="portchannel_id",
                             static_values="", label="Port-Channel (1-256)", svalue="1", mapval="", mandatory="1", order="2", recommended="1")
