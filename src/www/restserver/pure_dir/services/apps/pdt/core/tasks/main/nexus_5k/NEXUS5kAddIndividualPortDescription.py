...
metadata = dict(
    task_id="NEXUS5kAddIndividualPortDescription",
...
class NEXUS5kAddIndividualPortDescription:
    def __init__(self):
        pass
...
class NEXUS5kAddIndividualPortDescriptionInputs:
    nexus_id = Dropdown(
        hidden='True',
        isbasic='',
        helptext='',
...
class NEXUS5kAddIndividualPortDescriptionOutputs:
