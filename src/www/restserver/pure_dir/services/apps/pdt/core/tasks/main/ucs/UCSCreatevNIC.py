...
class UCSCreatevNICInputs:
    ...
    policy_name = Dropdown(hidden='False', isbasic='True', helptext='LAN Connectivity Policy name', api="getlanconpolicylist()|[fabric_id:1:fabric_id.value]", dt_type="string", label="LAN Policy", mapval="1", name="policy_name",
                           static="False", svalue="__t214.UCSCreateLANConnectivityPolicy.lan_conn_policy_name", mandatory='1', static_values="", order=2)
    vnic_name = Textbox(validation_criteria='str|min:1|max:128',  hidden='False', isbasic='True', helptext='vNIC Name', api="", dt_type="string", label="Name", mapval="0", name="vnic_name",
                        static="False", svalue="00-Mgmt-A", mandatory='1', static_values="", order=3, recommended="1")
    adaptor_policy_name = Dropdown(hidden='False', isbasic='True', helptext='Adapter policy', api="getadapterpolicy()|[fabric_id:1:fabric_id.value]", dt_type="string", label="Adapter Policy",
                                   mapval="0", name="adaptor_policy_name", static="False", svalue="VMWare", mandatory='1', static_values="", order=4)
    nw_templ_name = Dropdown(hidden='False', isbasic='True', helptext='vNIC Template name', api="getvnictemplate()|[fabric_id:1:fabric_id.value]", dt_type="string", label="vNIC Template", mapval="1", name="nw_templ_name",
                             static="False", svalue="__t207.UCSCreateMgmtvNiCTemplateForFabricA.mgmt_vnic_templ_name", mandatory='1', static_values="", order=5)
