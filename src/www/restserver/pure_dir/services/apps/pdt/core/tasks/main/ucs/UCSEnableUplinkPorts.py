...
class UCSEnableUplinkPortsInputs:
    ...
    ports = Multiselect(hidden='False', isbasic='True', helptext='Ethernet ports to configure as uplink', api="ucsmethports()|[fabric_id:1:fabric_id.value|ucs_fabric_id:1:ucs_fabric_id.value]", dt_type="list",
