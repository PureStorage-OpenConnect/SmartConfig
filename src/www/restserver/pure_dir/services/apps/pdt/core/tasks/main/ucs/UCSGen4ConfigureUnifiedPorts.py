...
metadata = dict(
    task_id="UCSGen4ConfigureUnifiedPorts",
    task_name="Configure Unified Ports for Gen4 FI",
    task_desc="Configure Unified Ports in UCS for Gen4 FI",
    task_type="UCSM"
)


class UCSGen4ConfigureUnifiedPorts:
    def __init__(self):
        pass
    ...
    def get_ucs_ports(self, keys):
        ...
        slot_info = {"min_range": str(1), "max_range": str(
            8), "min_fixed": False, "max_fixed": True, "min_interval": "2"}
        details['label'] = ""
        details['id'] = ""
        details['selected'] = str(1) + "-" + str(4)
...
class UCSGen4ConfigureUnifiedPortsInputs:
    fabric_id = Dropdown(
        hidden='',
        isbasic='True',
        helptext='',
...
class UCSGen4ConfigureUnifiedPortsOutputs:
