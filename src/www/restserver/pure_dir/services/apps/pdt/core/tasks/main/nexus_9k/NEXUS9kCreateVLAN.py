...
class NEXUS9kCreateVLANInputs:
    ...
    vlan_set = Group(
        ...
        hidden='',
        isbasic='True',
        helptext='Enter VLAN id and VLAN name',
        dt_type="string",
        static="False",
        api="",
        name="vlan_set",
...
class NEXUS9kCreateVLANOutputs:
