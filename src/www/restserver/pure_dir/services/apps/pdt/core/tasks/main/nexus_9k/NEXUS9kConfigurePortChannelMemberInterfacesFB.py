...
metadata = dict(
    task_id="NEXUS9kConfigurePortChannelMemberInterfacesFB",
...
class NEXUS9kConfigurePortChannelMemberInterfacesFB:
    def __init__(self):
        pass
        ...
        if cred:
            ...
            if obj:
                res = obj.nexusUnconfigurePortChannelMemberInterfaces(
                    inputs, logfile, flashBlade=True)
            else:
                customlogs("Failed to login to NEXUS switch", logfile)
                loginfo("Failed to login to NEXUS switch")
                res.setResult(False, PTK_INTERNALERROR,
...
class NEXUS9kConfigurePortChannelMemberInterfacesFBInputs:
    nexus_id = Dropdown(
        hidden='True',
        isbasic='',
        helptext='',
...
class NEXUS9kConfigurePortChannelMemberInterfacesFBOutputs:
