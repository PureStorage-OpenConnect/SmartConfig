...
class UCSCreateServiceProfileTemplateForiSCSIInputs:
    ...
    template_name = Textbox(validation_criteria='str|min:1|max:128',  hidden='False', isbasic='True', helptext='', dt_type="string", api="", static="False", static_values="", name="template_name",
                            label="Template Name", svalue="VM-Host-iSCSI-A", mandatory='1', mapval="0", order=2, recommended="1")
    ...
    lan_conn_policy_name = Dropdown(hidden='False', isbasic='True', helptext='LAN Connectivity policy', dt_type="string", api="getlanconnectivity()|[fabric_id:1:fabric_id.value]", static="False",
                                    static_values="", name="lan_conn_policy_name", label="LAN Connectivity policy", svalue="", mandatory='1', mapval="0", order=7)
    iqn_ident_pool_name = Textbox(validation_criteria='str|min:1|max:128',  hidden='False', isbasic='True', helptext='', dt_type="string", static="False", api="getiqnpool()|[fabric_id:1:fabric_id.value]", name="iqn_ident_pool_name", label="Initiator Name Assignment",
                                  static_values="", svalue="IQN-Pool", mapval="", mandatory="1", order=8)
    boot_policy_name = Dropdown(hidden='False', isbasic='True', helptext='Boot policy', dt_type="string", api="getbootpolicy()|[fabric_id:1:fabric_id.value]", static="False",
                                static_values="", name="boot_policy_name", label="Boot Policy", svalue="Boot-iSCSI-X-A", mapval="0", mandatory='1', order=9)
    iSCSI_vNIC_A = Dropdown(hidden='False', isbasic='True', helptext='iSCSI vNIC A', dt_type="string", api="getiSCSIvNIC()|[fabric_id:1:fabric_id.value]", static="False",
                            static_values="", name="iSCSI_vNIC_A", label="iSCSI_vNIC_A", svalue="iSCSI-A-vNIC", mapval="0", mandatory='1', order=10)
    iSCSI_vNIC_B = Dropdown(hidden='False', isbasic='True', helptext='iSCSI vNIC B', dt_type="string", api="getiSCSIvNIC()|[fabric_id:1:fabric_id.value]", static="False",
                            static_values="", name="iSCSI_vNIC_B", label="iSCSI_vNIC_B", svalue="iSCSI-B-vNIC", mapval="0", mandatory='1', order=11)
    pool_assignment = Dropdown(hidden='False', isbasic='True', helptext='Pool Assignment', dt_type="string", api="getpoolassignment()|[fabric_id:1:fabric_id.value]", static="False", static_values="",
                               mapval="1", name="pool_assignment", label="Pool Assignment", svalue="__t200.CreateServerPool.name", mandatory='1', order=12)
    power_policy_name = Dropdown(hidden='False', isbasic='True', helptext='Power control policy', dt_type="string", api="getpowerpolicy()|[fabric_id:1:fabric_id.value]", static="False",
                                 static_values="", name="power_policy_name", label="Power Policy", svalue="No-Power-Cap", mandatory='1', mapval="", order=13)
    biospolicy = Dropdown(hidden='False', isbasic='True', helptext='Server BIOS policy', dt_type="string", api="getbiospolicy()|[fabric_id:1:fabric_id.value]", static="False",
                          static_values="", name="biospolicy", label="BIOS Policy", svalue="VM-Host", mandatory='1', mapval="0", order=14)
