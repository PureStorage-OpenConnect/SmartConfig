...
class UCSAddiSCSIBootInputs:
    ...
    iSCSI_A_vNIC = Textbox(validation_criteria='',  hidden='False', isbasic='True', helptext='iSCSI-A-vNIC', dt_type="string", api="", static="False", static_values="",
                           name="iSCSI_A_vNIC", label="iSCSI vNIC", svalue="iSCSI-A-vNIC", mandatory="1", mapval="0", order=2)
    iSCSI_B_vNIC = Textbox(validation_criteria='',  hidden='False', isbasic='True', helptext='iSCSI-B-vNIC', dt_type="string", api="", static="False", static_values="",
                           name="iSCSI_B_vNIC", label="iSCSI vNIC", svalue="iSCSI-B-vNIC", mandatory="1", mapval="0", order=3)
