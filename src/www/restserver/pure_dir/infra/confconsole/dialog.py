...
class Dialog:
    ...
    def form(self, text, height=20, width=50, form_height=20, fields=[], **kwargs):
        ...
        for t in fields:
            ...
            if len(t) < 4:
                ...
                input_len = str(t[3])
            cmd.extend(((label, str(line), "1", item, str(line),
                         str(max_label_len + 2), field_len, input_len)))
            line += 1
    ...
    def passwordform(self, text, height=20, width=50, form_height=20, fields=[], **kwargs):
        ...
        """
        cmd = ["--passwordform", text,
               str(height), str(width), str(form_height)]
