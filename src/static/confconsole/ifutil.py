...
system_xml = "/mnt/system/pure_dir/system.xml"
...
class EtcNetworkInterfaces:
	...
	cmd="cp %s /etc/sysconfig/network-scripts/ifcfg-%s" %(self.CONF_FILE,ifname)
	os.system(cmd)
	...
	o = open(system_xml, "w")
        doc = Document()
        roottag = doc.createElement("DETAILS")
